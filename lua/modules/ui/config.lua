  ...
  require("lualine").setup {
    ...
    sections = {
      ...
      lualine_x = {
        diagnostic_section {
          sections = {'error'},
          color = lsp_colors.error,
          symbol = lsp_symbols.error,
          leading = ''
        }, diagnostic_section {
          sections = {'warn'},
          color = lsp_colors.warn,
          symbol = lsp_symbols.warn,
          leading = ' '
        }, diagnostic_section {
          sections = {'info'},
          color = lsp_colors.info,
          symbol = lsp_symbols.info,
          leading = ' '
        }, diagnostic_section {
          sections = {'hint'},
          color = lsp_colors.hint,
      ...
      lualine_y = {
        {"filetype"}, {"encoding", separator = ''}, {
          ...
          symbols = {
            unix = vim.loop.os_uname().sysname == 'Darwin' and '' or '',
            dos = '',
            mac = ''
          }
        }
